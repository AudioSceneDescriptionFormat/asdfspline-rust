    ...
    F: Fn(T) -> T,
{
    ...
    let times = [
        T::from_f32(-0.9841830547185881).unwrap(),
        T::from_f32(-0.9175983992229779).unwrap(),
        T::from_f32(-0.8015780907333099).unwrap(),
        T::from_f32(-0.6423493394403403).unwrap(),
        T::from_f32(-0.44849275103644687).unwrap(),
        T::from_f32(-0.23045831595513483).unwrap(),
    ...
    let weights = [
        T::from_f32(0.04048400476531615).unwrap(),
        T::from_f32(0.0921214998377276).unwrap(),
        T::from_f32(0.1388735102197876).unwrap(),
        T::from_f32(0.17814598076194554).unwrap(),
        T::from_f32(0.20781604753688862).unwrap(),
        T::from_f32(0.2262831802628975).unwrap(),
        T::from_f32(0.23255155323087406).unwrap(),
        T::from_f32(0.2262831802628975).unwrap(),
        T::from_f32(0.20781604753688862).unwrap(),
        T::from_f32(0.17814598076194554).unwrap(),
        T::from_f32(0.1388735102197876).unwrap(),
