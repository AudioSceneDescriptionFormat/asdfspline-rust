...
pub fn make_shape_preserving_cubic_spline<S: Scalar>(
...
pub fn make_shape_preserving_cubic_spline_with_slopes<S: Scalar>(
    values: impl Into<Vec<S>>,
    ...
    make_cubic_hermite_spline(&values, &slopes, &grid)
}
